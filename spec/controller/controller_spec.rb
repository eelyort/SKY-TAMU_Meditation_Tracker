...
RSpec.describe UsersController, type: :controller do
  describe 'create' do
    it 'successfully creates a new user' do
      User.create(username: 'testemail@tamu.edu', firstname: 'firstName', lastname: 'lastName', user_type: 1)
  ...
  describe 'update firstname' do
    it 'successfully updates a user firstname' do
      User.create(username: 'testemail@tamu.edu', firstname: 'firstName', lastname: 'lastName', user_type: 1)
      User.update(username: 'testemail@tamu.edu', firstname: 'firstname1', lastname: 'lastName', user_type: 1)
  ...
  describe 'update lastname' do
    it 'successfully updates a user lastname' do
      User.create(username: 'testemail@tamu.edu', firstname: 'firstName', lastname: 'lastName', user_type: 1)
      User.update(username: 'testemail@tamu.edu', firstname: 'firstName', lastname: 'lastName1', user_type: 1)
  ...
  describe 'update type' do
    it 'successfully updates a usertype' do
      User.create(username: 'testemail@tamu.edu', firstname: 'firstName', lastname: 'lastName', user_type: 1)
      User.update(username: 'testemail@tamu.edu', firstname: 'firstName', lastname: 'lastName', user_type: 2)
